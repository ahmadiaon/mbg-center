                    ...
                    <div id="married" class="pd-20 card-box mb-20">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="mother_in_law_place_birth"
                                        ...
                                        value="{{ old('mother_in_law_place_birth') }}" id="mother_in_law_place_birth"
                                        placeholder="Muara Teweh" type="text">
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div class="form-group">
                                    <label>Tanggal Lahir</label>
                                    <input name="mother_in_law_date_birth" value="{{ old('mother_in_law_date_birth') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="father_in_law_place_birth"
                                        ...
                                        value="{{ old('father_in_law_place_birth') }}" id="father_in_law_place_birth"
                                        placeholder="Muara Teweh" type="text">
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div class="form-group">
                                    <label>Tanggal Lahir</label>
                                    <input name="father_in_law_date_birth" value="{{ old('father_in_law_date_birth') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div class="form-group">
                                    <label>Jenis Kelamin</label>
                                    <select name="couple_gender" class="form-control">
                                        <option value="Laki-laki" {{ (old('couple_gender')=='Laki-laki' )?'selected':''
                                            }}>Laki-laki</option>
                                        <option value="Perempuan" {{ (old('couple_gender')=='Perempuan' )?'selected':''
                                            }}>Perempuan</option>
                                    </select>
                                </div>
                            </div>
