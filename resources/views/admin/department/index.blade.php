...
<div class="modal fade" data-backdrop="false" id="add_vehicle_modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content shadow-lg p-3 mb-5 bg-white rounded">
            ...
            <div class="modal-body">
                <form name="userForm" action="/admin/vehicle/" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Vehicle Group</label>
                                <select id="vehicle_group_id" name="vehicle_group_id"
                                    class="custom-select2 form-control" name="state" style="width: 100%; height: 38px">
